...
'''
    ...
    def _generate_model_code(self, data_schema):
        ...
        has_relations = any(
            (field.get('field_type') if isinstance(field, dict) else field.field_type) in ['RELATION_ONE_TO_ONE', 'RELATION_ONE_TO_MANY', 'RELATION_MANY_TO_MANY']
            for field in fields
        )
        ...
        for field in fields:
            ...
            model_fields.append(f"    {field_name} = {field_code}")
